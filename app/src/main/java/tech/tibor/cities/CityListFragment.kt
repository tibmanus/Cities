...
class CityListFragment : Fragment() {
    ...
    private var listAdapter: CitiesRecyclerViewAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.model.cities.observe(this, Observer {
            data ->
            if (data != null) {
                listAdapter?.values = data
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                listAdapter = CitiesRecyclerViewAdapter(null, listener)
                adapter = listAdapter
            }
        }
